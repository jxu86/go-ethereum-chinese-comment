...
type Header struct {
	ParentHash  common.Hash    `json:"parentHash"       gencodec:"required"` // 指向父区块的hash
	...
	Time        uint64         `json:"timestamp"        gencodec:"required"` // 区块“应该”被创建的时间
	Extra       []byte         `json:"extraData"        gencodec:"required"` //
	MixDigest   common.Hash    `json:"mixHash"`
	Nonce       BlockNonce     `json:"nonce"` // 随机数
